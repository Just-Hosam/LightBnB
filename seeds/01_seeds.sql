-- I saw the next exercise. I won't spend more time on data entry. Thank you.
DELETE FROM users;

INSERT INTO users (name, email, password)
VALUES ('Eva Stanley', 'sebastianguer@gmail.com', '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'),
